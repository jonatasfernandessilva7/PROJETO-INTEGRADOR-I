...
<body>
    <form action="/Aluno/login/home" method="POST" class="caixa">
        <h1>Seja bem vindo!</h1>
            ...
            <p><a href="/esqueceuASenha">Esqueceu a senha?</a></p>
            <button id="butEnter">Entrar</button>
            <button id="butCad"><a style="color: black;" href="cadastro">Cadastro</a></button>
